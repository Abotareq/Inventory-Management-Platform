...
namespace Inventory_Management_Platform.Domain.Order.Entites
{
    public sealed class OrderItem : Entity
    {
        ...
        private OrderItem(
            OrderItemId orderItemId, OrderId orderId, ProductId productId, WarehouseId warehouseId,
            int quantity, decimal unitPriceSnapshot)
        ...
        public static OrderItem Create(
            OrderId orderId, ProductId productId, WarehouseId warehouseId, int quantity, decimal unitPriceSnapshot)
        {
            return new OrderItem(
                OrderItemId.CreateUnique(), orderId, productId, warehouseId, quantity, unitPriceSnapshot);
        }
    }
}
