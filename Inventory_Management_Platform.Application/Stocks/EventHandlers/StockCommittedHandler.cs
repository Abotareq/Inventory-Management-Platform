...
{
    public sealed class StockCommittedHandler : INotificationHandler<StockCommitted>
    {
        private readonly IStockRepository _stockRepository;

        public StockCommittedHandler(IStockRepository stockRepository)
        {
            _stockRepository = stockRepository;
        }

        public async Task Handle(StockCommitted notification, CancellationToken cancellationToken)
        {
            var reservation = StockReservation.Create(
                notification.StockId, notification.OrderId, notification.Amount, "Committed",
